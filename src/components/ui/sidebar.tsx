  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-250 ease-[cubic-bezier(0.77,0,0.175,1)]',
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-250 ease-[cubic-bezier(0.77,0,0.175,1)] data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex',
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      // Password-manager extensions (Proton Pass, 1Password, etc.) inject
      // `data-protonpass-form=""` and similar on form-containing elements
      // before React hydrates. The injected attribute lives on this <main>
      // so suppress here to keep dev consoles clean. See react.dev/link/
      // hydration-mismatch.
